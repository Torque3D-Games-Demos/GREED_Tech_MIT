...
public:
	...
	//btSoftBody*		getBody(){return m_softBody;}; // softbodies dont exist in physx3 use cloth
...
/*
	/* support of soft bodies are removed in physx 3 */
	/*
	NxSoftBodyMesh* m_softBodyMesh;
	NxSoftBody* m_softBody;
	
	physx:::PxCloth* m_clothMesh;
	physx:::PxClothFabric* m_cloth;
	physx:::PxU32    m_vertNum;
	*/
